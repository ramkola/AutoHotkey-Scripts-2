...
#f::                ; Runs Clear Part of Pango Dimmer Window
...
#!s::               ; Runs Scintilla Commands and Message Numbers
...
#NumPad0::          ; Macro Recorder
{
    ...
    Else If (A_ThisHotkey = "#f")
        Run, MyScripts\Utils\Clear Part of Pango Dimmer Window.ahk
    ...
    Else If (A_ThisHotkey = "#!s")
        Run, MyScripts\Utils\Scintilla Commands and Message Numbers.ahk
    Else If (A_ThisHotkey = "#!+s")
...
{
    Run, C:\Users\Mark\Desktop\Misc\AutoHotkey Scripts\MyScripts\Utils\Web\Video (youtube) Remote Mouse Control.ahk
    Return
}
...
{
    Run, MyScripts\Utils\Lib Procedures - Display Proc Calls.ahk
    Return
}
...
^!+o::  ; output_debug("selected_word1: " selected_word1 " - selected_word2: " selected_word2)
{
    ...
    Else If (A_ThisHotkey = "^!+m")
        Run, MyScripts\Utils\OutputDebug Statement from Selected Text.ahk  "Label" "MsgBox"
    Else If (A_ThisHotkey = "^!o")
        Run, MyScripts\Utils\OutputDebug Statement from Selected Text.ahk  "NoLabel" "OutputDebug"
    Else If (A_ThisHotkey = "^!+o")
        Run, MyScripts\Utils\OutputDebug Statement from Selected Text.ahk  "Label" "OutputDebug"
    Return
}
