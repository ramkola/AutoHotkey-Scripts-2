...
q::
    ...
    ; imagesearch, ox, oy, x, y, x+w, y+h, *5 C:\Users\Mark\Desktop\Misc\resources\Images\Snooker147\cueball.png
    imagesearch, ox, oy, 640, 0 , 640 + 641, 0 + 529, *5 C:\Users\Mark\Desktop\Misc\resources\Images\Snooker147\cueball.png
    if (errorlevel = 0)
        MsgBox, 48,, % "found", 1
    else
